...
func init() {
	...
	installCmd.Flags().StringVarP(&installOptions.Env.Environment, "env", "e", "", "Supported KubeArmor Environment [k0s,k3s,microK8s,microshift,minikube,gke,bottlerocket,eks,docker,oke,generic]")
