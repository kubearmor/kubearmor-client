...
replace (
	...
	go.opentelemetry.io/otel/exporters/otlp/otlptrace => go.opentelemetry.io/otel/exporters/otlp/otlptrace v1.15.1
	...
	sigs.k8s.io/kustomize/api => sigs.k8s.io/kustomize/api v0.13.3
