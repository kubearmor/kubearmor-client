...
require (
	github.com/accuknox/auto-policy-discovery/src v0.0.0-20220829105122-5e9d79d2b60a
...
require (
	...
	github.com/kelseyhightower/buildinfo v0.0.0-20220601042906-9a40a48e5e9e // indirect
