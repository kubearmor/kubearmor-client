...
func (r TextReport) writeImageSummary(img *image.ImageInfo, outDir string, currentVersion string) {
...
func (r TextReport) Start(img *image.ImageInfo, outDir string, currentVersion string) error {
